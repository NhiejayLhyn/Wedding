...
The "Our Entourage" section (parents, sponsors, best man, maid of honor, groomsmen, flower girls, etc.) was transcribed from the uploaded invitation card images. It's collapsed behind a "View the full entourage" toggle to keep the mobile experience light — edit the names directly inside the `#entourage` section in `index.html`, or delete the whole `<section id="entourage">...</section>` block if you'd rather leave it off the website.
